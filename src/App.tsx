                ...
                <Card title="Ammonia VC Breakdown">
                  <div className="space-y-3">
                    ...
                    <div className="pt-3 border-t border-slate-800 flex justify-between">
                      ...
                      <span className="text-xs font-mono font-bold text-amber-500">${fmt(result.vcAmmBreakdown.total, 2)}/MT</span>
                    </div>
                  </div>
                </Card>
                ...
                <Card title="Methanol VC Breakdown">
                  <div className="space-y-3">
                    ...
                    <div className="pt-3 border-t border-slate-800 flex justify-between">
                      ...
                      <span className="text-xs font-mono font-bold text-amber-500">${fmt(result.vcMethBreakdown.total, 2)}/MT</span>
                    </div>
                  </div>
                </Card>
                ...
                <Card title="Urea VC Breakdown">
                  <div className="space-y-3">
                    ...
                    <div className="pt-3 border-t border-slate-800 flex justify-between">
                      ...
                      <span className="text-xs font-mono font-bold text-amber-500">${fmt(result.vcUreaBreakdown.total, 2)}/MT</span>
                    </div>
                  </div>
                </Card>
              </div>
